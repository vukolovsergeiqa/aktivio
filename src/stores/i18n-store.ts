...
const TRANSLATIONS: Record<Language, Record<string, any>> = {
  en: {
    ...
    add: {
      ...
      languagesLabel: 'Languages spoken (select at least one) *',
      langEn: 'English',
      langRu: 'Russian',
      langKa: 'Georgian',
  ...
  ru: {
    ...
    add: {
      ...
      languagesLabel: 'Языки мероприятия (выберите хотя бы один) *',
      langEn: 'Английский',
      langRu: 'Русский',
      langKa: 'Грузинский',
  ...
  ka: {
    ...
    add: {
      ...
      languagesLabel: 'ღონისძიების ენები (აირჩიეთ ერთი მაინც) *',
      langEn: 'ინგლისური',
      langRu: 'რუსული',
      langKa: 'ქართული',
